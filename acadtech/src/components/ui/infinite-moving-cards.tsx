  ...
  return (
    ...
    >
      <ul
        ref={scrollerRef}
        className={cn(
          " flex min-w-full shrink-0 gap-5 py-8 w-max flex-nowrap",
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[400px] h-80 content-center max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-[450px]"
            style={{
              background:
